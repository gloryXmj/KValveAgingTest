...
void apply(QApplication &app)
{
    ...
    app.setStyleSheet(QStringLiteral(
        ...
        "QPushButton[modeToggle=\"true\"] { background: #EEF3F8; color: #17324D; border: 1px solid #D1DBE8; }"
        "QPushButton[modeToggle=\"true\"]:hover { background: #E4ECF5; }"
        "QPushButton[modeToggle=\"true\"]:checked { background: #173B66; color: #FFFFFF; border: 1px solid #173B66; }"
        "QPushButton[modeToggle=\"true\"]:checked:hover { background: #153455; }"
        ...
        "QPushButton[cycleTest=\"true\"] { background: #E8EEF7; color: #17324D; border: 1px solid #D1DBE8; }"
        "QPushButton[cycleTest=\"true\"]:checked { background: #F79009; color: #FFFFFF; border: 1px solid #DC6803; }"
        "QPushButton[cycleTest=\"true\"]:checked:hover { background: #DC6803; }"
